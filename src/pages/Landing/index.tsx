...
const Glow = styled.div`
  ...
  top: 68px;
  bottom: 0;
  background: radial-gradient(72.04% 72.04% at 50% 3.99%, #f29f22 0%, #f26522 100%);
  filter: blur(72px);
  border-radius: 24px;
  max-width: 480px;
  width: 100%;
...
const TitleText = styled.h1<{ isDarkMode: boolean }>`
  ...
  background: ${({ isDarkMode }) =>
    isDarkMode
      ? 'linear-gradient(20deg, #f26522 10%, #f26522 100%)'
      : 'linear-gradient(10deg, #f26522 0%, #f26522 100%)'};
...
const ButtonCTA = styled(LandingButton)`
  background: linear-gradient(93.06deg, #f26522 2.66%, #f26522 98.99%);
  border: none;
